        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div>
              ...
              Add Global Certifications for a brighter <span className='font-bold text-transparent bg-clip-text bg-linear-to-r from-blue-600  via-orange-800 to-amber-800 italic'>
