...
const AIANavbar = () => {
  ...
  return (
    <div className="w-full">
      <TopHeader />
      <div className="flex my-10 justify-center md:justify-between bg-[hsl(var(--dark))]">
      ...
      <nav className="bg-white shadow-md sticky top-0 z-50 border-t ">
                  ...
                  <div key={index} className="border-b border-gray-200">
                    {item.submenu ? (
                      <>
                        ...
                        {activeDropdown === index && (
                          <ul className="hover-bg-primary-light rounded-md mb-4   ">
                            {item.submenu.map((subItem, subIndex) => (
                              <li key={subIndex}>
                                <a
                                  href={subItem.link}
 ...
 px-4 py-2.5
  ...
  "
                ...
                <div className="mt-6">
                  <a
                    href="/enroll-now"
                    className="block w-full bg-primary text-white text-center px-6 py-3 rounded-md font-semibold hover:opacity-90 transition-all"
                  >
                    Enroll Now
                  </a>
                </div>
