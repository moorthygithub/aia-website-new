...
// const ContactRecentPassout = ({ courseSlug, title }) => {
//   const {
...
//     queryFn: async () => {
//       const res = await axios.get(`${BASE_URL}/api/getAllTopStudent`);
//       return res.data;
//     },
//   });
...
//       alt: student.student_marks_image_alt || "Student Image",
...
//           description="Our successful graduates making a difference in the industry"
//           align="center"
//         />
//         <CardCarousel
