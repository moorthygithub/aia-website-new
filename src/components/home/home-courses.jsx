...
//     <div
//       ref={container}
//       className="flex items-center justify-center sticky top-50 py-8"
//     >
//       <motion.div
//         style={{
//           backgroundColor: service.bgColor,
//           scale,
//         }}
//         className="relative w-full rounded-none p-8 border-2 border-[#F3831C]/20 min-h-96 flex flex-col justify-between origin-top"
//       >
//         <div>
//           <div className="flex items-start justify-between mb-2">
//             <p
...
//       const cardIndex = Math.floor(clamped * ALL_SERVICES.length);
//       setActiveCard(cardIndex);
//     });
//     return () => unsubscribe();
...
//       const rect = rightCol.current.getBoundingClientRect();
//       setScrollFinished(rect.bottom <= window.innerHeight);
//     };
...
//   return (
//     <div className="max-w-340 mx-auto px-4 sm:px-6 lg:px-8 mt-4 mb-12">
//       <div className="md:hidden">
//         <SectionHeading title="Global Certification Programs Offered by AIA" />
...
//               <a
//                 href={service.link}
//                 className="group inline-flex items-center gap-2 h-10 px-4 rounded-md border border-[#F3831C]/30 bg-[#F3831C] text-sm font-medium text-white transition-colors duration-200 hover:bg-[#F3831C]/90 w-full justify-center"
//               >
//                 <span>{service.cta}</span>
//                 <svg
...
//               className="inline-flex items-center gap-2 h-10 px-4 bg-[#F3831C] text-sm font-medium text-white hover:bg-[#F3831C]/90 transition-colors duration-200"
//             >
//               <span>
//                 {ALL_SERVICES[activeCard]?.cta ?? ALL_SERVICES[0].cta}
//               </span>
